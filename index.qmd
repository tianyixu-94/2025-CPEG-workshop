...
![Bethany Allen <br> GFZ Helmholtz Centre for Geosciences, Germany](https://palaeoverse.org/images/logo.png){width="100%"}

:::

::: {.g-col-4}

![Chris Dean <br> University College London, UK](https://palaeoverse.org/images/logo.png){width="100%"}

:::

::: {.g-col-4}

![Erin Dillon <br> Smithsonian Tropical Research Institute, Panama](https://palaeoverse.org/images/logo.png){width="100%"}

:::

::: {.g-col-4}

![Harriet Drage <br> University of Lausanne, Switzerland](https://palaeoverse.org/images/logo.png){width="100%"}
...
![Will Gearty <br> Syracuse University, USA](https://palaeoverse.org/images/logo.png){width="100%"}

:::

::: {.g-col-4}

![Pedro Godoy <br> University of São Paulo, Brazil](https://palaeoverse.org/images/logo.png){width="100%"}

:::

::: {.g-col-4}

![Niklas Hohmann <br> Utrecht University, Netherlands](https://palaeoverse.org/images/logo.png){width="100%"}

:::

::: {.g-col-4}

![Lewis Jones <br> University College London, UK](https://palaeoverse.org/images/logo.png){width="100%"}
